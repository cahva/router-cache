...
- `DenoKvStore` — Deno KV cache store using Deno's built-in key-value database,
  with zero external dependencies and native TTL support
- Hono + Deno KV example (`examples/deno-hono-denokv/`)
